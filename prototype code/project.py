...
def start(feature):
    if feature == "1" or feature == "2":
        features_object = Feature("test/messi.jpg")
        ...
        features_object = Feature("test/test15.jpg")
        ...
        features_object = Feature("test/200.jpeg")
        ...
        features_object = Feature('test/image2.jpg')
        ...
        features_object = Feature('test/20-79.jpg')
        output = features_object.read_text()
    elif feature == "11" or feature == "12":
        features_object = Feature('test/pizza.jpeg')
